...
var son = {
  ...
  tirRoquette:function(){ this.souffle(900, 220, 0.35, 0.12); },
  tirMortier:function(){ this.bip("sine", 190, 70, 0.22, 0.13); },
  tirElectro:function(){ this.bip("square", 1400, 620, 0.10, 0.05); },
  electro:function(){ this.souffle(2600, 700, 0.28, 0.10); this.bip("sawtooth", 300, 90, 0.2, 0.06); },
  poudre:function(){ this.bip("triangle", 720, 1180, 0.10, 0.055); },
  gong:function(){ this.bip("sine", 520, 300, 0.30, 0.075); this.bip("sine", 780, 520, 0.22, 0.04); },
  fusee:function(){ this.bip("sine", 300, 1500, 0.5, 0.07); },
  fumigene:function(){ this.souffle(1800, 400, 0.65, 0.09); },
  soins:function(){ this.bip("sine", 520, 880, 0.28, 0.07); this.bip("sine", 660, 1040, 0.28, 0.05, 0.1); },
  barrage:function(){ for(var i = 0; i < 4; i++) this.bip("sine", 210, 80, 0.18, 0.07, i * 0.09); },
